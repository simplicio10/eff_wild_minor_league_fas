...
all_stats = pl.scan_csv('../files/stats/player_stats_updated.csv', schema_overrides={'PA': pl.Int64, 'TBF': pl.Int64})
...
stats_plus_id.collect().write_csv('../files/stats/player_stats_filtered.csv')