...
find_players_by_position = r'(?<!\w+?\.?\s[\w-’]+\s?(Royals|Dodgers|Angels|Mets|Yankees|Padres|Giants|Cardinals|Cadinals|Jays|Sox|Rays)?\s?)([A-Za-z\. ]+?), (1B|2B|3B|SS|IF|C|LF|CF|RF|OF|UTL|RHP|LHP)'
...
for team in list_of_comb_teams:
    ...
    players = [{'player_name':player_name, 'position':position} for _, player_name, position in player_matches]
...
df.write_csv('../files/free_agents/fas_24.csv')